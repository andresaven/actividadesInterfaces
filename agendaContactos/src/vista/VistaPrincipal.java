...
public class VistaPrincipal extends JFrame {
	...
	private void varInit () {
		...
		fav = new JButton();
		ImageIcon favIcon = new ImageIcon("megusta.png");
		fav.setIcon(favIcon);
		...
		ImageIcon searchIcon = new ImageIcon("lupa.png");
		...
		export = new JButton();
		ImageIcon optionsIcon = new ImageIcon("exportar.png");
		...
		delete = new JButton();
		ImageIcon dltIcon = new ImageIcon("eliminar.png");
		...
		ImageIcon addIcon = new ImageIcon("mas.png");
		...
		update = new JButton();
		ImageIcon updtIcon = new ImageIcon("editar.png");
